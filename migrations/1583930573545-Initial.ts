...
export class Initial1583930573545 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "${schema}"."token" ("id" integer NOT NULL, "name" text, "contractAddress" text NOT NULL, "symbol" text NOT NULL, "issuerId" integer, CONSTRAINT "token_pkey" PRIMARY KEY ("id"))`, undefined);
        await queryRunner.query(`CREATE UNIQUE INDEX "token_symbol_idx" ON "${schema}"."token" ("symbol") `, undefined);
        await queryRunner.query(`ALTER TABLE "${schema}"."token" ADD CONSTRAINT "token_issuerId_fkey" FOREIGN KEY ("issuerId") REFERENCES "${schema}"."user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`, undefined);
    }
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "${schema}"."token" DROP CONSTRAINT "token_issuerId_fkey"`, undefined);
